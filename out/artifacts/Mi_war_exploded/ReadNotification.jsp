            ...
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    <ul class="filter-list J_orderType">
                        ...
                        <li>
                            <a id="J_unpaidTab" href="getUnreadNotification.action">未读消息</a>
                        </li>
                        <li class="active">
                            <a id="J_sendTab" href="" class="active">已读消息</a>
                        </li>
                    </ul>
                </div>
                <div class="box-bd" style="margin-top: 40px;">
                    <c:if test="${empty read}">
                        <div class="noNo">暂无消息通知</div>
                    </c:if>
                    <div id="J_orderList">
                        <ul class="order-list">
                            <form class="layui-form" action="registInfo.action" method="post" accept-charset="utf-8">
                                <c:forEach items="${read}" var="note">
                                    <li class="uc-order-item uc-order-item-pay" style="margin-top: 40px">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="col-main" style="margin-left: -20px; width: 100px;">
                                                        <input type="checkbox" name="zzz" lay-skin="switch"
                                                               lay-text="已读|未读" checked disabled>
                                                    </th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                <tr>
                                                    <td class="order-items" style="height: 80px;width: 300px;">
