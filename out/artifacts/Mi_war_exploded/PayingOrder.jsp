    ...
    <div class="uc-box uc-main-box">
        <div class="uc-content-box order-list-box">
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    ...
                    <ul class="layui-input-block layui-col-md4 layui-col-md-offset10">
                        <form class="" id="searchOrder" action="selectOrderByKey.action?status=1">
            ...
            <div class="box-bd" style="margin-top: 80px;">
                <div id="J_orderList">
                    <ul class="order-list">
                        <c:forEach items="${payingOrder}" var="order">
                                ...
                                <div class="order-detail">
                                    <div class="order-summary">
                                        <div class="order-status">
                                            ...
                                            <c:if test="${order.orderStatus==4}">已关闭</c:if>
                                        </div>
                                    </div>
