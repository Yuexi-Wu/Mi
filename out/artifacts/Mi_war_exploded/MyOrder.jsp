            ...
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    <ul class="filter-list J_orderType">
                        <li class="active">
                            <a href="" data-type="0" class="active">全部有效订单</a>
                        </li>
                        <li>
                            <a id="J_unpaidTab" href="payingOrder.action?accountId=${account.accountId}">待支付</a>
                        </li>
                        <li>
                            <a id="J_sendTab" href="shippingOrder.action?accountId=${account.accountId}">待收货</a>
                        </li>
                        <li>
                    ...
                    <ul class="layui-input-block layui-col-md4 layui-col-md-offset10">
                        <form class="" id="searchOrder" action="selectOrderByKey.action">
                            ...
                            <div class="order-detail">
                                <div class="order-summary">
                                    <div class="order-status">
                                        <c:if test="${order.orderStatus==1}">等待付款</c:if>
                                        <c:if test="${order.orderStatus==2}">等待收货</c:if>
                                        <c:if test="${order.orderStatus==3}">已到货</c:if>
                                    ...
                                    <tr>
                                        <td class="order-items">
                                            <ul class="goods-list">
                                                ...
                                                <li>
                                                    ...
                                                    <p class="name">
                                                        <a href="loadProductSpecs.action?productName=${item.product.productName}">
                                        ...
                                        <td class="order-actions">
                                            <c:if test="${order.orderStatus==1}">
                                                <a class="layui-btn layui-btn-danger" href="showOrder.action?method=payConfirm&orderId=${order.orderId}">立即支付</a>
                                            </c:if>
