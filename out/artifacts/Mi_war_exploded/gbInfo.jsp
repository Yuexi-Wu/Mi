            ...
            <div style="margin-bottom: 20px">
                <div class="layui-input-inline">
                    <input id="gbName" type="text" name="gbName" autocomplete="off" class="layui-input"
                           style="width: 350px" value="${gb.gbName}" disabled>
                </div>
            </div>
            <!-- 团购活动描述 -->
            <div style="margin-bottom: 20px">
            ...
            <div style="margin-bottom: 20px">
                <div class="layui-input-inline">
                    ...
                    <input id="gbStart" class="layui-input layui-input-inline"
                           style="width: 250px; margin-left: 30px" value="${gb.gbStartString}" disabled>
                </div>
            </div>
            <!-- 团购活动结束时间 -->
            <div style="margin-bottom: 20px">
                <div class="layui-input-inline">
                    ...
                    <input id="gbEnd" class="layui-input-inline layui-input"
                           style="width: 250px; margin-left: 30px" value="${gb.gbEndString}" disabled>
                </div>
            </div>
            <!-- 商品设置 -->
                ...
                <c:forEach items="${gb.gbProducts}" var="gbp">
                    <div class="gb_product_item">
                        <div style="margin-bottom: 10px; display: none">
                            ...
                            <input name="productId" value="${gbp.product.productId}" type="text" class="layui-input layui-input-inline product-id" style="width: 150px; margin-left: 30px" disabled>
                        </div>
                        <div style="margin-bottom: 10px">
                            <label class="layui-input-inline" style="color: #757575">商品名:</label>
                            <input name="productInfo" value="${gbp.product.productName} ${sp.product.productColor} ${sp.product.productVersion} ${sp.product.productSize}" type="text" class="layui-input layui-input-inline product-info" style="width: 220px; margin-top: 10px; margin-left: 30px" disabled>
                        </div>
                        <div style="margin-bottom: 10px">
                            <label class="layui-input-inline" style="color: #757575">数量:&nbsp&nbsp&nbsp</label>
                            <input name="gbpAmount" value="${gbp.gbpAmount}" type="number" class="layui-input layui-input-inline" style="width: 220px; margin-left: 30px" disabled>
                        </div>
                        <div style="margin-bottom: 10px">
                            <label class="layui-input-inline" style="color: #757575">团购价:</label>
                            <input name="gbpPrice" value="${gbp.gbpPrice}" type="number" class="layui-input layui-input-inline" style="width: 220px; margin-left: 30px" disabled>
                        </div>
                    </div>
                </c:forEach>
            </div>
