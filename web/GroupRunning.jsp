    ...
    <div class="uc-box uc-main-box">
        <div class="uc-content-box order-list-box">
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    <ul class="filter-list J_orderType">
                        <li>
                            <a href="groupOrder.action" data-type="0">全部团购订单</a>
                        </li>
                        <li>
                            <a id="J_unpaidTab" href="groupReady.action">待成团</a>
                        </li>
                        <li class="active">
                            <a id="J_sendTab" href="">待收货</a>
                        </li>
                        <li>
                            <a href="groupOver.action">已关闭</a>
                        </li>
                    </ul>
                </div>
            </div>
            <c:if test="${empty groupRunning}">
                <div>
                    <p style="font-size: 20px;margin-top: 100px;margin-bottom:20px; text-align: center; margin-top: 50px;margin-left: -70px; float: left;color: #7c7c7c;">
                        暂无符合条件团购订单</p>
                </div>
            </c:if>
            <div class="box-bd" style="margin-top: 80px;">
                <div id="J_orderList">
                    <ul class="order-list">
                        <c:forEach items="${groupRunning}" var="order">
                            <li class="uc-order-item uc-order-item-pay">
                                <div class="order-detail">
                                    <div class="order-summary">
                                        <div class="order-status">等待收货</div>
                                    </div>
