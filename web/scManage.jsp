...
<div class="layui-layout-admin">
    ...
    <div class="layui-side" style="background-color: #393D49">
        <ul class="layui-nav layui-nav-tree">
            ...
            <li class="layui-nav-item layui-this"><a href="scManage.jsp"><i class="layui-icon layui-icon-list" style="margin-right: 5px"></i>二级分类管理</a></li>
                ...
                <div class="layui-form table-search">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-inline" style="position:absolute; right: 100px">
                            <button class="layui-btn layui-btn-normal layui-btn-radius"><i class="layui-icon layui-icon-add-circle"></i>添加二级分类</button>
                        </div>
                    </div>
                </div>
