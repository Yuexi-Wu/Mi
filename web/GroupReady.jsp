    ...
    <div class="uc-box uc-main-box">
        <div class="uc-content-box order-list-box">
            <div class="box-hd">
                ...
                <div class="more clearfix">
                    <ul class="filter-list J_orderType">
                        <li>
                            <a href="groupOrder.action">全部团购订单</a>
                        </li>
                        <li class="active">
                            <a href="">待成团</a>
                        </li>
                        <li>
                            <a href="groupRunning.action">待收货</a>
                        </li>
                        <li>
            ...
            <div class="box-bd" style="margin-top: 80px;">
                <div id="J_orderList">
                    <ul class="order-list">
                        <c:forEach items="${groupReady}" var="order">
                            <li class="uc-order-item uc-order-item-pay">
                                <div class="order-detail">
                                    <div class="order-summary">
                                        <div class="order-status">等待成团</div>
                                    </div>
